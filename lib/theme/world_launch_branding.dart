...
class WorldLaunchBranding {
  ...
  static WorldLaunchBranding _westernLuxury(WorldProfile profile) {
    return WorldLaunchBranding(
      ...
      profileLabel: profile.label,
      backgroundTop: const Color(0xFFF6F1E7),
      backgroundBottom: const Color(0xFFFFFDF8),
      accent: const Color(0xFFD4AF37),
      secondaryAccent: const Color(0xFF6D2138),
      glow: const Color(0x33D4AF37),
      scanLineColor: const Color(0x18D9D2C3),
      pulseColor: const Color(0xFFB89A4F),
      particleColor: const Color(0xFFD4AF37),
      subtitleColor: const Color(0xFF6B6258),
      pinStroke: const Color(0xFF1E2A44),
      hornFill: const Color(0xFF1E1A17),
      titleHeadlineColor: const Color(0xFF1E1A17),
      coreColor: const Color(0xFFD4AF37),
      coreGlow: const Color(0x886D2138),
      isLightBackground: true,
      showReadyLabel: false,
    );
  }
