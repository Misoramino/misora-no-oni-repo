...
class WorldLaunchBranding {
  ...
  static WorldLaunchBranding _cyber(WorldProfile profile) {
    ...
    return WorldLaunchBranding(
      ...
      backgroundTop: const Color(0xFF05070D),
      backgroundBottom: const Color(0xFF0D1220),
      accent: t.markerAccent,
      secondaryAccent: const Color(0xFF7A3CFF),
      glow: const Color(0x3800F0FF),
      scanLineColor: const Color(0x182D5BFF),
      pulseColor: t.playerRingColor,
      particleColor: const Color(0xFF00F0FF),
      subtitleColor: const Color(0x996C7A96),
      pinStroke: const Color(0xFFF7FDFF),
      hornFill: const Color(0xFF0D1220),
      titleHeadlineColor: const Color(0xFFEAFBFF),
      coreColor: const Color(0xFF00F0FF),
      coreGlow: const Color(0x667A3CFF),
  ...
  static WorldLaunchBranding _magical(WorldProfile profile) {
    return WorldLaunchBranding(
      ...
      profileLabel: profile.label,
      backgroundTop: const Color(0xFF191722),
      backgroundBottom: const Color(0xFF262235),
      accent: const Color(0xFFC6A45A),
      secondaryAccent: const Color(0xFF5B4A8C),
      glow: const Color(0x665B4A8C),
      scanLineColor: const Color(0x333F4F88),
      pulseColor: const Color(0xFF6FC9D8),
      particleColor: const Color(0xFFA685E2),
      subtitleColor: const Color(0xFFC7C1B0),
      pinStroke: const Color(0xFFF2EEDC),
      hornFill: const Color(0xFFD9CFB6),
      titleHeadlineColor: const Color(0xFFF2EEDC),
      coreColor: const Color(0xFF6FC9D8),
      coreGlow: const Color(0xBB4A79C7),
      isLightBackground: false,
      showReadyLabel: false,
    );
  }
  ...
  static WorldLaunchBranding _westernLuxury(WorldProfile profile) {
    return WorldLaunchBranding(
      ...
      profileLabel: profile.label,
      backgroundTop: const Color(0xFFF8F6F2),
      backgroundBottom: const Color(0xFFF2EEE7),
      accent: const Color(0xFFC8A75A),
      secondaryAccent: const Color(0xFF8C6A3B),
      glow: const Color(0x22C8A75A),
      scanLineColor: const Color(0x12D9D2C5),
      pulseColor: const Color(0xFFD8C68C),
      particleColor: const Color(0xFFC8A75A),
      subtitleColor: const Color(0xFF6B665F),
      pinStroke: const Color(0xFF5C5246),
      hornFill: const Color(0xFF2F2C29),
      titleHeadlineColor: const Color(0xFF2F2C29),
      coreColor: const Color(0xFFC8A75A),
      coreGlow: const Color(0x558C6A3B),
      isLightBackground: true,
      showReadyLabel: false,
    );
  }
