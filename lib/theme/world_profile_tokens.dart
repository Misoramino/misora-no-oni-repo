  ...
  static WorldProfileTokens of(WorldProfile profile) {
    return switch (profile) {
      WorldProfile.horror => const WorldProfileTokens(
          ...
          alertColor: Color(0xFF6D4C4F),
          infoColor: Color(0xFF455A64),
          dangerTextPrefix: '危険',
          warningTextPrefix: '警戒',
          safeTextPrefix: '静寂',
          markerAccent: Color(0xFF78909C),
          playerRingColor: Color(0xFF607D8B),
          playAreaColor: Color(0xFF263238),
          traceColor: Color(0xFF546E7A),
          revealRingColor: Color(0xFF5C6BC0),
          commJammingColor: Color(0xFF5D4037),
          cameraSenseColor: Color(0xFF90A4AE),
          captureZoneColor: Color(0xFF6D4C4F),
          editDraftColor: Color(0xFF455A64),
        ),
      ...
      WorldProfile.japaneseLuxury => const WorldProfileTokens(
          safeColor: Color(0xFF2E4036),
          alertColor: Color(0xFF5C4038),
          infoColor: Color(0xFF3D4A5C),
          dangerTextPrefix: '祟り',
          warningTextPrefix: '気配',
          safeTextPrefix: '静寂',
          markerAccent: Color(0xFF9A8B5A),
          playerRingColor: Color(0xFFB8A88A),
          playAreaColor: Color(0xFF263238),
          traceColor: Color(0xFF4A5568),
          revealRingColor: Color(0xFF9A8B5A),
          commJammingColor: Color(0xFF6D5B4B),
          cameraSenseColor: Color(0xFF8A7B55),
          captureZoneColor: Color(0xFF5C4038),
          editDraftColor: Color(0xFF5C4A42),
        ),
