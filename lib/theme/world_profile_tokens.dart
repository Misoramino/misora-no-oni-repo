  ...
  static WorldProfileTokens of(WorldProfile profile) {
    return switch (profile) {
      ...
      WorldProfile.magical => const WorldProfileTokens(
          safeColor: Color(0xFF72E6A6),
          alertColor: Color(0xFFFF8A3D),
          infoColor: Color(0xFF44E5FF),
          dangerTextPrefix: '呪い',
          warningTextPrefix: '予兆',
          safeTextPrefix: '結界',
          markerAccent: Color(0xFF44E5FF),
          playerRingColor: Color(0xFF44E5FF),
          playAreaColor: Color(0xFF3B285F),
          traceColor: Color(0xFFA99BC2),
          revealRingColor: Color(0xFFE0B84F),
          commJammingColor: Color(0xFF3B285F),
          cameraSenseColor: Color(0xFFE0B84F),
          captureZoneColor: Color(0xFFFF8A3D),
          editDraftColor: Color(0xFF7A3CFF),
          mapIcons: WorldMapIconColors(
            player: Color(0xFF44E5FF),
            hunter: Color(0xFF7A3CFF),
            runner: Color(0xFF72E6A6),
            werewolf: Color(0xFFB06BFF),
            safeZone: Color(0xFF72E6A6),
            infoBroker: Color(0xFF44E5FF),
            camera: Color(0xFFE0B84F),
            jamming: Color(0xFF3B285F),
            accusation: Color(0xFFE0B84F),
            capture: Color(0xFFFF8A3D),
            trace: Color(0xFFA99BC2),
          ),
        ),
      ...
      WorldProfile.westernLuxury => const WorldProfileTokens(
          safeColor: Color(0xFFE9DFC8),
          alertColor: Color(0xFF6D2138),
          infoColor: Color(0xFFB89A4F),
          dangerTextPrefix: '危険',
          warningTextPrefix: '監視',
          safeTextPrefix: '安寧',
          markerAccent: Color(0xFFD4AF37),
          playerRingColor: Color(0xFF1E2A44),
          playAreaColor: Color(0xFF1E2A44),
          traceColor: Color(0xFF8C7A55),
          revealRingColor: Color(0xFFD4AF37),
          commJammingColor: Color(0xFF6B6258),
          cameraSenseColor: Color(0xFF1E2A44),
          captureZoneColor: Color(0xFF6D2138),
          editDraftColor: Color(0xFFB89A4F),
          mapIcons: WorldMapIconColors(
            player: Color(0xFF1E2A44),
            hunter: Color(0xFF6D2138),
            runner: Color(0xFF2F5D50),
            werewolf: Color(0xFF4B3B6B),
            safeZone: Color(0xFFE9DFC8),
            infoBroker: Color(0xFFB89A4F),
            camera: Color(0xFF1E2A44),
            jamming: Color(0xFF6B6258),
            accusation: Color(0xFFD4AF37),
            capture: Color(0xFF6D2138),
            trace: Color(0xFF8C7A55),
          ),
        ),
    };
  }
