...
abstract final class SkillCatalog {
  ...
  static const runnerSkills = [
    ...
    SkillHelpEntry(
      ...
      body:
          '地図タップで捕獲結界を設置（鬼の接触圏・パニック圏とは別）。範囲内の相手をロックし、至近またはBLEで捕獲しやすくします。'
  ...
  static const hunterSkills = [
    SkillHelpEntry(
      ...
      body:
          '発動時に「自分（鬼）の名前付き暴露」か「逃走者1人をランダムに選んで名前付き暴露」の2択。'
    ...
    SkillHelpEntry(
      ...
      iconName: 'near_me',
      body:
          '地図上（現在地から約90m以内）に人形を置き、短時間そこを捕獲判定の中心にします。'
    ...
    SkillHelpEntry(
      ...
      iconName: 'trip_origin',
      body:
          '地図タップで捕獲結界を設置（鬼の接触圏・パニック圏とは別）。範囲内の逃走者をロックし、至近またはBLEで捕獲しやすくします。'
