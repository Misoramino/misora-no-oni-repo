...
enum AccusationWeight {
  ...
  String get helperText => switch (this) {
        AccusationWeight.instantWin =>
          '正解で${GuideTerms.humanFaction}の即勝利。外すと告発者が脱落（${GuideTerms.echoForm}）。',
  ...
  String get successOutcomeLabel => switch (this) {
        AccusationWeight.instantWin => '${GuideTerms.humanFaction}の即勝利',
  ...
  String get failureOutcomeLabel => switch (this) {
        AccusationWeight.instantWin =>
          '即脱落（${GuideTerms.echoForm}として${GuideTerms.secondGame}へ）',
